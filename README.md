...
Built during a hackathon using a document- and test-driven "vibe coding" workflow: specs and
tests were written first, and implementation was generated against them to keep AI-assisted
code accountable to a fixed contract rather than drifting from requirements.
